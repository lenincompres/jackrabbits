class TEXT {
  static SUBTITLE = {
    ESP: "Descubre maravillas mientras viajas</br>al reino de conejos y barajas.",
  ...
  static CATCH_PRHASE = {
    ESP: `<b class="fortune">Fortuna</b>, <b class="courage">Coraje</b>, <b class="wisdom">Sapiencia</b> y <b class="charm">Encanto</b> <br/>son las cualidades que tienes a mano.`,

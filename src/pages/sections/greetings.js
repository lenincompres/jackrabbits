...
const greetingsSection = {
  ...
  p: Copy.text({
    ...
    en: [
      ...
      `An auspicious quest is in order. The Order of Messenger Rabbits of the Citadel is ordering a race to procure royals to be ordained as the council of thirds—the highest order a rabbit of this order can receive:`,

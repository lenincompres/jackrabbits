...
const songRoot = "https://d2lwuy8qc234o3.cloudfront.net/1/clip/";

new Song(Copy.text({
  es: songRoot + "7ebe2edb-0248-468e-8bde-bbd463472746.m4a",
  en: songRoot + "30cccf19-43ea-47de-9242-3e0db1cd82fb.m4a",
}), Copy.text({
  es: "Escudos",
  en: "Sheilds",
...
new Song(Copy.text({
  es: songRoot + "19b4e0c1-1a7c-40b1-bf62-291885d189bd.m4a",
  en: songRoot + "24cd3ee7-8b57-49c6-a10f-74b42027fba1.m4a",
}), Copy.text({
  es: "Antorchas",
  en: "Torches", // test 
...
new Song(Copy.text({
  es: songRoot + "76396428-4e55-4fce-9dac-f5e288295eb6.m4a",
  en: songRoot + "308c0b78-8f60-4ae7-a81d-765f4b81f2aa.m4a",
}), Copy.text({
  es: "Herraduras",
  en: "Horseshoes",
...
new Song(Copy.text({
  es: songRoot + "6e389263-7175-4d9e-945b-3d70fe4f1ce8.m4a",
  en: songRoot + "fd56cdbf-06d8-4cdb-a9ba-5c14f5b3eb94.m4a",
}), Copy.text({
  es: "Bellotas",
  en: "Acorns",
...
new Song(Copy.text({
  es: songRoot + "7dafc484-95e3-4788-9db6-9f5fd90f0c33.m4a",
  en: songRoot + "dfd6cae0-db07-421b-a3f6-75b9151f26b5.m4a",
}), Copy.text({
  es: "Campanas",
  en: "Bells",
...
new Song(Copy.text({
  es: songRoot + "3223e8c3-f7ff-4cf5-b551-cc41b8697069.m4a",
  en: songRoot + "d1a61cae-0ac7-4242-b6ad-86462b352786.m4a",
}), Copy.text({
  es: "Anclas",
  en: "Anchors",
...
new Song(Copy.text({
  es: songRoot + "8c74776c-2443-47b0-9a45-6f6de2a4b35e.m4a",
  en: songRoot + "11b22c3b-da12-449c-b684-2773bd88d38b.m4a",
}), Copy.text({
  es: "Conchas",
  en: "Shells",
...
new Song(Copy.text({
  es: songRoot + "8acb5e3f-9ffb-415a-82a9-9dca904a838e.m4a",
  en: songRoot + "6f419fc9-c880-4b4b-91d4-099813715fd0.m4a",
}), Copy.text({
  es: "Carámbanos",
  en: "Icicles",
...
new Song(Copy.text({
  es: songRoot + "7fffa99e-8cc9-4bbc-8386-6da7fde80091.m4a",
  en: songRoot + "6515898e-a134-42b2-a8fa-b46b9ae3b3e8.m4a",
}), Copy.text({
  es: "Flores",
  en: "Fleurs",
...
new Song(Copy.text({
  es: songRoot + "b91f6452-bc5e-4e68-82cb-fe71ea2841f4.m4a",
  en: songRoot + "6a1c0391-7e56-42ce-b527-1431ced9d1e7.m4a",
}), Copy.text({
  es: "Corceles",
  en: "Cavaliers",
...
new Song(Copy.text({
  es: songRoot + "2d5b36c6-4efa-46e5-b106-f79c60435c02.m4a",
  en: songRoot + "9233ee4f-c7e0-426e-8fdd-110a7ce201b8.m4a",
}), Copy.text({
  es: "Enlaces",
  en: "Liaisons",
...
new Song(Copy.text({
  es: songRoot + "9aaf7eed-7273-418f-9d1d-25ec73bea16b.m4a",
  en: songRoot + "db9795e3-1547-4797-9185-86efaca3f216.m4a",
}), Copy.text({
  es: "Andares",
  en: "Allures",
}), () => {

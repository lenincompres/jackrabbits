...
window.addEventListener("load", () => DOM.get("*[lang]") && DOM.get("*[lang]").forEach(el => el.let("display", el.get("lang") === Copy.lang ? "block" : "none")));
 ...
 class Copy {
  ...
  static treat(str, vars = []) {
    ...
    str = str.replaceAll(/—(?!-)/g, '—<span class="em-dash">--</span>');
